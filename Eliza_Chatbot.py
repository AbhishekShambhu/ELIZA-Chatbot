...
# #Eliza Chatbot
# 
# I started of by importing the regular expression(re), random, datetime and time library.
# Then I added the dictionary for most used nouns(Noun_dict) and pronouns(Pronoun_dict)
# which would help in word spotting from the questions and transform it according to the answers.
# Then I added the Expressions as in Regular Expressions - using the re library to match the 
# questions or statements given by user as input and then some random answers(using the random
#  library)
#
# #What my Chatbot can do? -I have tried to implement the chatbot using pattern matching techniques - 
